...
<body id="body-pd">
        ...
        <nav class="nav">
            <div> <a href="#" class="nav_logo"> <i class="bx bx-layer nav_logo-icon"></i> <span class="nav_logo-name">Gestion Bijouterie</span> </a>
                <div class="nav_list">
                    ...
                    <a href="#" class="nav_link"> <i class="bx bx-package nav_icon"></i> <span class="nav_name">Stock</span> </a>
    ...
    <div class="container-fluid mt-5 pt-5">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800 w-100 text-center">Liste des produits</h1>
        ...
        <div class="card shadow mb-4">
            <div class="card-header d-flex justify-content-between py-3">
                ...
                <a href='stock0.php'><button class="btn btn-danger" type="submit">Stock Zéro</button></a>
                <a href='export.php'><button class="btn btn-success" type="submit"name="exporter">Exporter</button></a>
                    ...
                    <table class="table table-striped table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        while ($prod = mysqli_fetch_array($res)) {
                            ...
                            <tr class='bg-danger'>
                                ...
                                <td>" . $prod['poids'] . "</td>
                                <td>" . $prod['qte'] . "</td>
                                <td><a href='modif_prod.php?numserie=$numserie'' class='btn btn-warning btn-sm mb-2' align='center' >Modifier</a></td>
                                <td><a href='impression.php?numserie=$numserie'' class='btn btn-warning btn-sm mb-2' align='center' >Imprimer</a></td>
                                <td><a href='supprod.php?numserie=$numserie' onclick= 'return confirm(\"Etes vous sûr de supprimer un produit?\")' class='btn btn-warning btn-sm mb-2' align='center'>Supprimer</a></td>
                            </tr>
                            ";
                            }
                            else{
                                ...
                                <td>" . $prod['poids'] . "</td>
                                <td>" . $prod['qte'] . "</td>
                                <td><a href='modif_prod.php?numserie=$numserie'' class='btn btn-primary btn-sm mb-2' align='center' >Modifier</a></td>
                                <td><a href='impression.php?numserie=$numserie'' class='btn btn-primary btn-sm mb-2' align='center' >Imprimer</a></td>
                                <td><a href='supprod.php?numserie=$numserie' onclick= 'return confirm(\"Etes vous sûr de supprimer un produit?\")' class='btn btn-primary btn-sm mb-2' align='center'>Supprimer</a></td>
                            </tr>
                            ";
                            }
                        }
