...
<body id="body-pd">
        ...
        <nav class="nav">
            <div> <a href="#" class="nav_logo"> <i class="bx bx-layer nav_logo-icon"></i> <span class="nav_logo-name">Gestion Bijouterie</span> </a>
                <div class="nav_list">
                    ...
                    <a href="reparation.php" class="nav_link"> <i class='bx bx-wrench'></i> <span class="nav_name active">Reparation</span> </a>
    ...
    <div class="container-fluid mt-5 pt-5">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800 w-100 text-center">Liste des Reparation</h1>


        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header d-flex align-items-center justify-content-between py-3">
                <h6 class="m-0 font-weight-bold text-primary">liste des reparation</h6>
                <a href="ajouter_rep.php"><button class="btn btn-primary">Ajouter un reparation</button></a>
                            ...
                            $numserie = $prod["numserie"];
                                ...
                                echo "
                                    <tr>
                                        ...
                                        <td>".$prod["karat"]."</td>
                                        <td>".$prod["prixReparation"]."</td>
                                        <td>".$prod["poids"]."</td>
                                        <td>".$prod["qte"]."</td>
                                        <td>".$prod["dateRep"]."</td>
                                        <td>".$prod["responsable_rep"]."</td>
                                        <td class='text-center text-lg' ><a class='text-danger' href='supprimerRep.php?nums=$numserie'><i class='bx bxs-trash' ></i></a></td>
                                    </tr>
                            </tr>
                            ";
                            }
