...
<body id="body-pd">
        ...
        <nav class="nav">
            <div> <a href="#" class="nav_logo"> <i class="bx bx-layer nav_logo-icon"></i> <span class="nav_logo-name">Gestion Bijouterie</span> </a>
                <div class="nav_list">
                    ...
                    <a href="#" class="nav_link"> <i class='bx bx-category-alt nav_icon'></i> <span class="nav_name">Catégorie</span> </a>
    ...
    <div class="container-fluid mt-5 pt-5">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800 w-100 text-center">Liste des catégories</h1>
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header d-flex justify-content-between py-3">
                <h6 class="m-0 font-weight-bold text-primary">Liste des catégories:</h6>
                <a href='ajoutcat.php'><button class="btn btn-primary" type="submit">Ajouter</button></a>
            </div>
            <div class="card-body">
                    ...
                    <table class=" table table-striped table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            while ($r = mysqli_fetch_array($res)) {
                                ...
                                echo "<tr>
                                    <td>" . $cat . "</td>
                                    <td><a href='changer_cat.php?cat=$cat''><img src='..\img\modif.jpg' width='40px' height='40px' alt='Modifier' title='Modifier'></a></td>
                                    <td><a href='supcat.php?cat=$cat' onclick= 'return confirm(\"Etes vous sûr de supprimer une catégorie?\")'><img src='..\img\suppr.png' width='50px' height='40px' alt='Supprimer' title='Supprimer'></a></td>
                                </tr>";
                            }
