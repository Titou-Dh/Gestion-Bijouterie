...
<body id="body-pd">
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            ...
            </div> <a href="logout.php" class="nav_link" name="logout"> <i class="bx bx-log-out nav_icon"></i> <span
                    class="nav_name">Déconnection</span> </a>
        </nav>
    </div>
<!--Container Main start-->

    <main>
    <div class="sucess " style="padding-top:90px;">
